  ...
  return (
    <>
               ...
               <div className="col-12">
                  <nav className="site-navigation text-right ml-auto" role="navigation">
                     <ul className="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                        <li style={{ margin: '15px', textDecoration: 'underline' }} className="text-decoration-underline"><Link to={`/`}>Book</Link></li>
      ...
      <div class="container">
         <div class="text">
            <p>
            This is the text paragraph that is positioned on the left side of the layout. You can add more text here to describe the image on the right, or simply provide information as needed.
            </p>
         </div>
         <div class="image">
